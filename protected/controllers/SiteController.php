...
class SiteController extends Controller
{
    ...
    if(isset($state)){
      if($state == 'sysadmin'){
        $this->redirect('/yii/application/index.php/analytics/index');
      }else{
        $this->redirect('/yii/application/index.php/bills/index');
      }
    }
      ...
      try {
        ...
        if ($user) {
          ...
          if($user->paypal_account == 'sysadmin'){
				    ...
				    $this->redirect('/yii/application/index.php/analytics/index');//Yii::app()->user->returnUrl);
          }
